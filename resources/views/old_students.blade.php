                ...
                <!-- progressbar -->
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            @if(app()->getLocale() == 'ar')
                                <p class="text-right">
                                    عزيزنا ولي الأمر.. يرجى الاطلاع على آلية تقسيط الرسوم، حيث يتم تقسيط الرسوم وقدرها 315$ على 3 دفعات وفق التفصيل التالي:-
                                </p>
                            ...
                            @else
                                ...
                                <p>
                                    Dear Guardian, Please see the fee installment method, where the fees of $315 is paid in 3 installments according to the following details:
                                </p>
                                ...
                                <div class="w-100">
                                    <table class="table table-bordered text-center" id="table-installment">
                                        ...
                                        <tr>
                                            ...
                                            <td class="green">40%</td>
                                            <td class="green">125$</td>
                                            <td class="green">When registering</td>
                                        </tr>
                                        <tr>
